 ...
 *弹窗类
 */
var StagePop = (function (_super) {
    __extends(StagePop, _super);
    function StagePop(_par) {
        var _this = _super.call(this) || this;
        _this.showStatus = false;
        _this.sendBool = false; //标记是否在消息发送中
        _this.par = _par;
        _this.createView(); //构建显示元素
        return _this;
    }
    //构建显示元素
    StagePop.prototype.createView = function () {
        //屏蔽层
    ...
    StagePop.prototype.showThis = function (_str) {
        if (this.showStatus)
            return;
    ...
    StagePop.prototype.removeThis = function () {
        if (this.showStatus) {
    ...
    //添加按钮触摸侦听
    StagePop.prototype.addBtnTouchEvent = function () {
    ...
    //移除按钮触摸侦听
    StagePop.prototype.removeBtnTouchEvent = function () {
    ...
    //按钮点击 
    StagePop.prototype.onTapTouch = function (event) {
        if (this.sendBool)
            return;
        switch (event.target) {
            ...
            case this.join_btn://加入按钮
                this.sendBool = true; //标记是否在消息发送中
                //发送加入棋局的消息
                var _magStr_l = '{"type":"joinGame","uid":"' + Global.uid +
            ...
            case this.bystande_btn://旁观者按钮
                this.sendBool = true; //标记是否在消息发送中
                //发送旁观棋局的消息
                var _magStr_l = '{"type":"viewer","uid":"' + Global.uid +
    ...
    //无用点击 
    StagePop.prototype.onTapTouch_bak = function (event) {
        //egret.log("");
    };
    return StagePop;
}(egret.Sprite));
__reflect(StagePop.prototype, "StagePop");
//# sourceMappingURL=StagePop.js.map